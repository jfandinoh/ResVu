...
const router = Router();
import {scanRepositoryById,statusScanRepositoryById} from '../controllers/scan.controller'
 ...
 */
router.get('/scan/repository/:id',scanRepositoryById);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.get('/scan/status/repository/:id',statusScanRepositoryById);
